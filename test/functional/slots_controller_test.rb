...
class SlotsControllerTest < ActionController::TestCase
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post :create, slot: { end: @slot.end, semester: @slot.semester, start: @slot.start, weekday: @slot.weekday }
    end
  ...
  test "should update slot" do
    put :update, id: @slot, slot: { end: @slot.end, semester: @slot.semester, start: @slot.start, weekday: @slot.weekday }
    assert_redirected_to slot_path(assigns(:slot))
  end
